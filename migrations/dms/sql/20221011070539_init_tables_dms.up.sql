...
CREATE TABLE
    PC_REGISTER_PACKAGE_ITEM (
        PACKAGE_ITEM_ID VARCHAR (36) PRIMARY KEY,
        CREATED_BY VARCHAR (36) NOT NULL,
        CREATED_DATE TIMESTAMP
        WITH
            TIME ZONE NOT NULL,
...
CREATE TABLE
    PC_REGISTER_PACKAGE_LIST_ITEM (
        PACKAGE_LIST_ITEM_ID VARCHAR (36) PRIMARY KEY,
        CREATED_BY VARCHAR (36) NOT NULL,
        CREATED_DATE TIMESTAMP
        WITH
            TIME ZONE NOT NULL,
        ...
        WITH
            ...
            PACKAGE_ITEM_ID VARCHAR (36) NOT NULL,
...
CREATE TABLE
    PC_REGISTER_PROJECT_USER (
        PROJECT_USER_ID VARCHAR (36) PRIMARY KEY,
        CREATED_BY VARCHAR (36) NOT NULL,
        CREATED_DATE TIMESTAMP
        WITH
            TIME ZONE NOT NULL,
