...
func (h *Handlers) ListDealerByCode(c *fiber.Ctx) error {
	...
	//	return err
	//}
	resp, err := h.dealerService.ListDealerByCode(c.UserContext(), pointer.Get[dealer.ListDealerRequest](req.Criteria), req.Pagination)
	if err != nil {
		return err
	}
